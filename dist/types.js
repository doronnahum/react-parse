...
exports['default'] = {
  ...
  DELETE_DOCUMENT_FROM_SERVER: 'DELETE_DOCUMENT_FROM_SERVER',
  // New Document
  ...
  LOGIN: '_LOGIN',
  CREATE_DOCUMENT_START: '_CREATE_DOCUMENT_START',
  CREATE_DOCUMENT_FAILED: '_CREATE_DOCUMENT_FAILED',
  CREATE_DOCUMENT_SUCCESS: '_CREATE_DOCUMENT_SUCCESS',
  DELETE_DOCUMENT_START: '_DELETE_DOCUMENT_START',
  DELETE_DOCUMENT_FAILED: '_DELETE_DOCUMENT_FAILED',
  DELETE_DOCUMENT_FINISHED: '_DELETE_DOCUMENT_FINISHED',
  UPDATE_DOCUMENT_START: '_UPDATE_DOCUMENT_START',
  UPDATE_DOCUMENT_FAILED: '_UPDATE_DOCUMENT_FAILED',
  UPDATE_DOCUMENT_FINISHED: '_UPDATE_DOCUMENT_FINISHED'
};
