...
var getDocumentData = (0, _reselect.createSelector)(getImmutableDocument, function (immutableDocument) {
  return immutableDocument.get('data') && immutableDocument.get('data').toJS();
});
exports.getDocumentData = getDocumentData;
var getDocumentStatus = (0, _reselect.createSelector)(getImmutableDocument, function (immutableDocument) {
